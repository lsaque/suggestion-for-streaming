...
import conmebolIcon from "../../../assets/images/streamers/icons/conmebol.png";
import premiereIcon from "../../../assets/images/streamers/icons/premiere.png";
...
const ButtonSuggestionCard: React.FC<IButtonSuggestionCardProps> = ({
  image,
  platformType,
  movieTitle,
}) => {
  ...
  switch (platformType) {
    ...
    case 2:
      ...
      break;
    case 3:
      platform = premiereIcon;
      label = "Premiere";
      color = "#2C8F3C";
      break;
    case 4:
      platform = conmebolIcon;
      label = "Conmebol";
      color = "#05589C";
      break;
  }
